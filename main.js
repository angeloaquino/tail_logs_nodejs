var fs = require('fs');
var http = require('http'); //change to https but needs certificate .pem .cer
var hostname = '127.0.0.1'; // IP localhost
var port = 3000; //port interchangebale
var process = require('process');
var Tail = require('tail').Tail;

var options = {  // object for PS API Status 
    hostname: 'localhost',
    port: 8080,
...
var server = http.createServer((req, res) => { // function to create page and display status
    //res.statusCode = 200;
...
server.listen(port, hostname, () => { //server site is running
  console.log(`Server running at http://${hostname}:${port}/servicecheck.html`);
});
